...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      // tabIndex makes the scroll container keyboard-reachable when a table is
      // wider than its viewport (axe `scrollable-region-focusable`). Cells wrap
      // (see note above), so this only engages when a table still overflows.
      tabIndex={0}
